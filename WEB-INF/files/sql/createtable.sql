...
(
	NUTRIENT_ID NUMBER(10) NOT NULL,
	PHYSICAL_NAME NVARCHAR2(16) NOT NULL UNIQUE,
	LOGICAL_NAME NVARCHAR2(16) NOT NULL UNIQUE,
...
CREATE VIEW RECIPE_MATERIAL_QUANTITIES AS SELECT R.RECIPE_ID AS RECIPE_ID, R.QUANTITY AS QUANTITY, M.MATERIAL_NAME AS MATERIAL_NAME, M.GRAM_PER_QUANTITY AS GRAM_PER_QUANTITY, M.PREFIX AS PREFIX, M.POSTFIX AS POSTFIX, M.NUTRIENT_ID AS NUTRIENT_ID  FROM RECIPE_MATERIALS R INNER JOIN MATERIALS M ON (R.MATERIAL_NAME = M.MATERIAL_NAME AND R.PREFIX = M.PREFIX AND R.POSTFIX = M.POSTFIX) ORDER BY QUANTITY * GRAM_PER_QUANTITY DESC;
...
COMMENT ON COLUMN NUTRIENTS.PHYSICAL_NAME IS '栄養素物理名';
COMMENT ON COLUMN NUTRIENTS.LOGICAL_NAME IS '栄養素論理名';
